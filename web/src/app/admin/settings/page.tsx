// /admin/settings — 팀 단위 설정 (Membership-Admin 또는 Owner 접근 가능).
//   - 자기 팀의 사용자별 권한 부여 (Membership / Billing)
//   - 30일+ 비활성 사용자 alert
//   - 데이터 보관 기간 (Phase 4.2)
//
// 모든 팀 현황 / 새 팀 생성 / view-as 같은 Platform 레벨 기능은 /admin/platform 으로 분리됨.

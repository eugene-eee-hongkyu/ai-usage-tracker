...
import { getAllChangelogEntries, parseMarkdown, type InlineToken, type MdToken } from "@/lib/changelog";
    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-12">
        ...
        {entries.length === 0 ? (
          ...
          entries.map((entry) => (
            <article key={entry.slug} className="border-l-2 border-neutral-800 pl-5 space-y-3">
              <div>
                <p className="text-xs text-neutral-500 font-mono">
                  {new Date(entry.date).toLocaleDateString("ko", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                  })}

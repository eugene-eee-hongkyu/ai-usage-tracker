...
export const ko: DeepPartial<Messages> = {
  ...
  teamPlanHealth: {
    ...
    verdictDowngrade: "▼ 다운",
    verdictFit: "✓ 적정",
    verdictTight: "▲ Plan 잘 활용",
    verdictOver: "▲▲ Power User",
    verdictUtilFmt: "Plan 의 {pct}%",
    verdictHitFmt: "한도 {n}회",
    footnote: "※ 평가는 월 API 환산 비용 (ccusage) vs Plan 가격 비율 기반. 30일 윈도우 / 활성 7일+ 멤버만 평가. 업그레이드 권장은 안 함 (Anthropic 의 5h cap 단위 미공개).",
  },
  planHealth: {
  ...
  landing: {
    heroTitle: "우리 팀의 AI 활용을 한 화면에",
    heroSubtitle: "Claude Code 사용량·효율·팀 위치까지. 한 번 설치하면 자동으로 쌓입니다.",
    cardUsageTitle: "사용량·효율을 한 페이지에",
    cardUsageBody: "토큰·비용·캐시 히트·1-shot 비율이 한 화면에. 어디서 줄여야 하는지 즉시 보임.",
    cardGlobalTitle: "글로벌에서 우리 팀 위치",
    cardGlobalBody: "다른 팀과 비교한 효율 점수·토큰 단가. 익명화된 랭킹으로 객관적 비교.",
    cardEfficiencyTitle: "누가 가장 많이·효율적인지",
    cardEfficiencyBody: "팀 안에서 누가 cache 잘 쓰고 1-shot 비율 높은지. 평가용 아닌 self-coaching.",
    trust: "개인 정보 없이, 외부 호출 없이, 정확한 공식. 메타데이터만 수집하고 코드·프롬프트·응답은 절대 수집하지 않습니다.",
    cta: "시작하기",
  ...
  teamView: {
    ...
    topTokenUsersTitle: "Top 토큰 사용 · 팀 {n}명",
    teamSum: "팀 합산",
    ...
    teamLabel: "{team} 팀",
    headlineTitle: "{team} — 업계 비교 ($/active day, 최근 30일)",
    teamAvgN: " · 팀 평균 ({n}명)",
  ...
  dashboardView: {
    ...
    weekdayFri: "금",
    weekdaySat: "토",
    teamPositionTitle: "팀 내 내 위치 · {period} · {n}명 중",
    teamPositionLabelUsage: "사용량",
    teamPositionLabelCost: "비용",
    teamPositionLabelCacheHit: "cache hit",
    teamPositionLabelPower: "활용 지수",
    teamPositionTeamAvg: "팀 평균 {avg}",
    teamPositionMeFirst: "★ 팀 1위 (나)",
    teamPositionTeamFirst: "팀 1위 {name} {val}",
  },
  teamUsageHero: {
    powerLabel: "⚡ 팀 활용 지수",
